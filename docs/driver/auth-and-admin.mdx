...
This page is based on the real exported admin/auth types and services in:

- `sdks/ldb-driver/ts-js/src/services/*.ts`
- `sdks/ldb-driver/ts-js/src/types/admin.ts`
- `sdks/ldb-driver/ts-js/src/auth/types.ts`

The behavior notes are also aligned with the live docs test at
