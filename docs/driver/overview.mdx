...
description: Deep overview of @liorandb/driver@2.0.5 and its public API surface.
---
...
This documentation provides a complete guide to using the LioranDB V2 Pre-Alpha TypeScript/JavaScript Driver. It covers installation, connection setup, supported database operations, API usage, and essential workflows for integrating LioranDB into TypeScript and JavaScript applications.
...
- Current documented npm version: `2.0.5`
