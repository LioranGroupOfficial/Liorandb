...
sidebar_position: 1
title: CLI Overview
description: Source-backed overview of @liorandb/cli@1.0.4, including global flags, command groups, output modes, storage behavior, and testing coverage.
---
...
- `sdks/ldb-cli/ts-js/src/cli.ts`
- `sdks/ldb-cli/ts-js/src/commands/*.ts`
- `sdks/ldb-cli/ts-js/src/shell/*.ts`

The docs here are also aligned with the repository smoke test in:

- `sdks/ldb-cli/ts-js/scripts/test-all.mjs`

That test currently covers:

- version and config bootstrap
- login and session reuse
- database and collection setup
- direct CRUD commands
- shell startup and shell command execution
- secondary and text index flows
- cluster readiness and settings inspection
- backup creation, verification, and cleanup
