...
This page is based on the real command handlers in:

- `sdks/ldb-cli/ts-js/src/commands/db.ts`
- `sdks/ldb-cli/ts-js/src/commands/collection.ts`
- `sdks/ldb-cli/ts-js/src/commands/crud.ts`
- `sdks/ldb-cli/ts-js/src/commands/indexes.ts`

The examples here are also aligned with the repository smoke test in:
